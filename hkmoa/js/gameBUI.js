...
export class GameBUI extends Scene
{
    ...
    init (data)
    {
        ...
        console.log('[GameBUI] init -> language: ' + this.language);
    }
    ...
    create (data)
    {
        ...
        this.progressBarBG = this.add.image(0, 0, 'B-progress', 'progress-bar-bg');
        this.progressBarFill = this.add.image(0, 0, 'B-progress', 'progress-bar-fill');
        ...
        {
            // create images
            const node = this.add.image(posX + i * stepX, 0, 'B-progress', 'progress-bar-step');
            const complete = this.add.image(posX + i * stepX, 0, 'B-progress', 'progress-bar-step-complete');
            ...
            const text = this.add.image(posX + i * stepX, 100, 'B-progress', this.language === 0 ? 'progress-text' + (i+1) +'-cht' : 'progress-text' + (i+1) + '-eng');
            // add to container
        ...
        const currentStepBG = this.add.image(0, 0, 'B-progress', 'progress-bar-step-current');
        const currentStepFrame = this.add.image(0, 0, 'B-progress', 'progress-bar-step-current-frame');
        this.currentStepFill = this.add.image(0, 0, 'B-progress', 'progress-bar-step-current-fill');
